...
classSelect.addEventListener("change", function () {
  ...
  if (selectedText.includes("7th")) marksLabel.textContent = "Class 6th Percentage * (In case the exam is not completed, Enter 0)";
  else if (selectedText.includes("8th")) marksLabel.textContent = "Class 7th Percentage * (In case the exam is not completed, Enter 0)";
  else if (selectedText.includes("9th")) marksLabel.textContent = "Class 8th Percentage * (In case the exam is not completed, Enter 0)";
