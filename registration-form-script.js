...
classSelect.addEventListener("change", function () {
  ...
  if (selectedText.includes("7th")) marksLabel.textContent = "Class 6th Percentage * (If Class 6th Exam Not Done Yet enter 0)";
  else if (selectedText.includes("8th")) marksLabel.textContent = "Class 7th Percentage * (If Class 7th Exam Not Done Yet enter 0)";
  else if (selectedText.includes("9th")) marksLabel.textContent = "Class 8th Percentage * (If Class 8th Exam Not Done Yet enter 0)";
  else if (selectedText.includes("10th")) marksLabel.textContent = "Class 9th Percentage * (If Class 9th Exam Not Done Yet enter 0)";
  else if (selectedText.includes("11th")) marksLabel.textContent = "Class 10th Percentage * (If Class 10th Exam Not Done Yet enter 0)";
  else if (selectedText.includes("12th")) marksLabel.textContent = "Class 10th Percentage * (If Class 10th Exam Not Done Yet enter 0)";
  else marksLabel.textContent = "Previous Class Percentage *";
});
